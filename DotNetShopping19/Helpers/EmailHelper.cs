...
namespace DotNetShopping.Helpers
{
    public class EmailHelper
    {
        ...
        public void SendOrderReceivedEmail(Order order, HttpRequestBase Request, System.Web.Mvc.UrlHelper Url)
        {
            var fileContents = System.IO.File.ReadAllText(HostingEnvironment.MapPath(@"~/Content/Email/OrderReceived.html"));
            ...
            fileContents = fileContents.Replace("[#ORDERTOTAL#]", "$" + order.TotalPrice.ToString());
