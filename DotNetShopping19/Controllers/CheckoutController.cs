    ...
    public class CheckoutController : Controller
    {
        ...
        public ActionResult CheckoutPay(CheckoutModel checkout, CreditCardModel card, String paypal)
        {
            ...
            try
            {
                ...
                decimal campaignDiscount = co.CalculateDiscount(cart);
                order.Discount = paymentDiscount + campaignDiscount;
                order.TotalPrice = (productTotal + shippingCost - paymentDiscount - campaignDiscount) * 1.18M;
                ...
                emailHelper.SendOrderReceivedEmail(order, Request, Url);
